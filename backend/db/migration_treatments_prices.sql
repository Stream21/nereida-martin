...
UPDATE treatments SET tag = 'Mantenimiento',                duration_min = 45,  duration_max = NULL, price = 15  WHERE id = 'brow-design-seguimiento';
UPDATE treatments SET tag = 'Primera vez',                  duration_min = 45,  duration_max = NULL, price = 18  WHERE id = 'brow-design-primera';
...
UPDATE treatments SET name = 'Korean Lash Lift', tag = 'Lifting coreano + tinte', duration_min = 60, duration_max = NULL, price = 60 WHERE id = 'lash-lift-korean';
...
-- Gema dental: precio "desde 25€", a valorar según diseño.
UPDATE treatments SET name = 'Gema dental', tag = 'Swarovski (desde)', price = 25 WHERE id = 'smile-gem';
